...
<%@ page import="io.github.phuocnguyenhuu.model.Helper,io.github.phuocnguyenhuu.model.User" %>
<%
String message = "";
if(request.getParameter("submit") != null){
	...
	//user.phone = request.getParameter("phone"); not necessary. I will develop in the future
	user.password = request.getParameter("password");
	//user.address = request.getParameter("address"); // not necessary. I will develop in the future
	user.rule="user"; // Defaul when sign up is user
