	...
	<form class="register_form form_login" action="Login.jsp" method="post">		
		<div class="row">
			...
			<div class="owl-carousel home_page_slider">
			  <div class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/slide1.png)">
			  	</div>
			  </div>
			  <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/slide2.png)">
			  	</div>
			  </div>
			  <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/slide3.png)">
			  	</div>
			  </div>
			  <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/slide4.png)">
			  	</div>			  	
			  </div>
			  <div  class="item">
			  	<div class="rs_single_slide" style="background-image:url(images/slide5.png)">
			  	</div>			  	
			  </div>
			</div>
			</div>
